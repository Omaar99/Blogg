...
@session('success')
        ...
        class="relative flex flex-col sm:flex-row sm:items-center bg-gray-300
            dark:bg-green-700 shadow rounded-md py-5 pl-6 pr-8 sm:pr-6 mb-3 mt-3">
	    <div class="flex flex-row items-center border-b sm:border-b-0 w-full
		sm:w-auto pb-4 sm:pb-0">
		    <div class="text-green-300" dark:text-gray-500>
			    <svg class="w-6 sm:w-5 h-6 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"> </svg>
			</div>
        <div class="text-sm font-medium ml-3 dark: text-gray-100">Success! . </div>
        </div>
        <div class="text-sm tracking-wide Otext-gray-500
        dark:text-white mt-4 sm:mt-0 sm:ml-4"> {{ session('success') }} </div>
        ...
        cursor-pointer">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="ht"> </svg>
        </div>
        </div>
@endsession
            <div class="flex justify-between items-center">
                ...
                <div> 
                <!-- <a href="{{route( 'notes.create' )}}" class="float-right inline-flex
                    items-center px-4 py-2 bg-green-500 dark:bg-green-500/100
                    ...
                    dark:hover:bg-green-400 focus:bg-green-700 dark:focus:bg-green
                    active:bg-green-900 dark:active:bg-gray-300 focus:outline-none
